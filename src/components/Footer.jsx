...
const Footer = ({}) => {
    ...
    return (
        <>
 <div className="w-full h-[400px] bg-blue-900 flex flex-col justify-center items-center">
  <div className="w-[70%] flex justify-start items-center ">
    <img className="h-12 " src="https://uiparadox.co.uk/templates/medicare/v3/assets/media/brand-logo.png" alt="" />

    <div className="flex space-x-4 mt-28 ml-[-200px]">
  ...
  <h2 className="text-[30px] text-white border-b-2 border-white">Contact Us</h2>
...
<div className="px-20 flex flex-col">
  <h2 className="text-[30px] text-white border-b-2 border-white" >Newsletter</h2>

  <div className="mt-5 flex flex-col items-center space-y-4 ">
    <p className="text-[16px] text-white">Enter your email address to receive up-to-date <br /> news, new patient information and other useful <br /> stuff, delivered right to your inbox.</p>
    <form action="" className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3 " >
      <input type="email" id="Email" name="Email" placeholder="Enter your Email"   className="text-black border border-gray-500 p-[10px] w-[250px] sm:w-full " />
      <button className="p-[10px] bg-black text-white hover:bg-gray-400 text-center cursor-pointer sm:mt-0 mt-4 w-[250px] sm:w-auto pr-3">Submit</button>
